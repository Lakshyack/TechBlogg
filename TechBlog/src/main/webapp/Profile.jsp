<%@page import="com.tech.blog.entities.Message" %>
  ...
  <%@page import="com.tech.blog.helper.ConnectionProvider" %>
    ...
    <% User user=(User)session.getAttribute("currentUser"); if(user==null){ response.sendRedirect("loginPage.jsp"); } %>
      <!DOCTYPE html>
      <html lang="en">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark primary-background">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item active">
                <a class="nav-link" href="#"><span><img src="SVGs/learn.svg" alt="">&nbsp;</span>Learn Code With Lakshya
          ...
          <a class="nav-link disabled" href="#">More</a>
            ...
            <ul class="navbar-nav mr-right">
              <li class="nav-item">
                <a class="nav-link" href="#!" data-toggle="modal" data-target="#profile-modal"><span><img class="icon"
                      src="SVGs/logout.svg" alt=""></span>
                  <%= user.getName() %>
                </a>
              </li>
                  ...
                  <div class="modal-body">
                    <div class="container text-center">
                      ...
                      <img src="ProfileImg/<%= user.getProfile() %>" class="img-fluid "
                        style="border-radius: 50%; height: 150px; width: 150px; border: 2px solid black;" alt="">
                  ...
                  <div class="modal-body">
                    <form action="addPostServlet" method="post">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        <textarea class="form-control" placeholder="Enter your content" name="" id="" cols="30" rows="3"></textarea>
                      </div>

                      <div class="form-group">
                        <textarea class="form-control" placeholder="Enter your program (if you have)" name="" id="" cols="30" rows="3"></textarea>
                      </div>
