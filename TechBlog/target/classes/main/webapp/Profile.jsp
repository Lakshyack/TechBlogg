        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="#"><span><img src="SVGs/learn.svg" alt="">&nbsp;</span>Lear Code With Lakshya
            ...
            <li class="nav-item">
              <a class="nav-link" href="#" data-toggle="modal" data-target="#add-post-modal"><span><img src="SVGs/upload.svg" alt="">&nbsp;</span>Do Post</a>
            </li>
